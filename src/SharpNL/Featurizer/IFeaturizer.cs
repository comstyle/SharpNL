...
namespace SharpNL.Featurizer {
    ...
    public interface IFeaturizer {
        ...
        /// <returns>An array of feature tags for each token in the sequence.</returns>
        string[] Featurize(string[] tokens, string[] tags);
        ...
        /// <returns>The top k feature sequences for the specified sentence.</returns>
